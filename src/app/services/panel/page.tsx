                    ...
                    <div className="grid grid-cols-1 gap-8">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image src="/images/sandwich-panel/sandwich-small.webp" alt={t('pnType1Title' as any)} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="p-6">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image src="/images/sandwich-panel/hangar-sandwich.webp" alt={t('pnType2Title' as any)} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="p-6">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100">
                            <div className="relative h-64 w-full group overflow-hidden">
                                <Image src="/images/sandwich-panel/sandwich-panel-2.webp" alt={t('pnType3Title' as any)} fill className="object-cover group-hover:scale-105 transition-transform duration-500" />
                            </div>
                            <div className="p-6">
